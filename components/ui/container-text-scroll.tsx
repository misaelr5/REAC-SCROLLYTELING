...
export const Card = ({
  ...
  return (
    <motion.div
      ...
      className="relative h-[30rem] md:h-[40rem] w-full border border-[#b566ff]/25 bg-[#060606] rounded-[24px] shadow-2xl overflow-hidden"
    >
      <div className="h-full w-full rounded-2xl bg-[#060606]">
        {children}
      </div>
    </motion.div>
  );
